        ...
        return (
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 reveal-stagger">
              {tierObjects.map((obj) => (
                <article key={obj.id} className="reveal group">
                  <Link href={`/objects/${obj.id}`} className="block">
                    ...
                    >
                      {/* Hover overlay — formation + hours (desktop only) */}
                      <div
                    ...
                    {/* Mobile-visible metadata (hidden on desktop where hover overlay serves this role) */}
                    <div className="mt-2 mb-1 md:hidden">
                      <p
                        className="text-meta uppercase tracking-wider"
                        style={{ color: "var(--accent-earth)", fontSize: "10px" }}
                      >
                        {obj.materials.join(" · ")}
                      </p>
                      <p
                    ...
                    <p className="text-meta mb-2 hidden md:block" style={{ color: "var(--text-tertiary)" }}>
